...
client = commands.Bot(description="Here is some commands for you", command_prefix=commands.when_mentioned_or("s!"), pm_help = True)


async def status_task():
    while True:
        await client.change_presence(game=discord.Game(name='for Soyal || s!help'))
